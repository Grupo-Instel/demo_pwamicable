...
class SocialController extends Controller
{
    ...
    public function add(Request $request){
        ...
        toast('Red social creada exitosamente','success');
    ...
    public function update(Request $request){
        ...
        toast('Red social modificada','success');
        return redirect()->route('listSocial');  
    }
    ...
    public function agregar_quitar_rs($id,$valor){
        ...
        if ($countSlide >= 4 && $valor == 1) {
            ...
            toast('A alcanzado el numero maximo de elementos','warning');
        ...
        //Valida que tipo de alerta mostrara segun el estado de la red social
        if ($valor == 1) {
            toast('Red social publicada correctamente','success');
        }else {
            toast('Se ha ocultado Red social correctamente','success');
        }
