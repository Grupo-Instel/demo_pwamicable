...
<nav class="navbar navbar-dark fixed-top navbar-expand-md" style="background-color: {{ session('navBarColor') }}">
    <a class="navbar-brand" href="#">
        ...
        <img src="{{ asset(session('navBarLogo'))}}" width="160" class="d-inline-block align-top" id="logo_navplayer" alt="" loading="lazy">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav" >
        <ul class="navbar-nav ml-auto">
            <!--
            <li class="nav-item" >
                <a  class="btn " id="btn"  name="url" role="button" style="color:white;">
            ...
            -->
            <li class="nav-item" >
                <a class="nav-link " href="{{url('portfolio')}}" style="color: {{ session('iconNavBarColor') }}"><i class="fa fa-arrow-left"></i> &nbsp;  Inicio </a>
            </li>
            <li class="nav-item">
